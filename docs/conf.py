...
project = 'Competancy_mgt'
copyright = u'2015 - {0}, Saifali Saiyyad'.format(datetime.utcnow().year)
...
try:
    release = pkg_resources.get_distribution('competancy_mgt').version
except pkg_resources.DistributionNotFound:
    print('Competancy_mgt must be installed to build the documentation.')
...
html_theme_options = {
    "contribute": True,
    "github_fork": "saifali_saiyyad/competancy-mgt",
    "github_ribbon_color": "white_ffffff",
    "github_user": "saifali_saiyyad",
}
...
#
# html_title = 'Competancy_mgt v0.1'
...
htmlhelp_basename = 'Competancy_mgtdocs'
...
latex_documents = [
    (master_doc, 'Competancy_mgt.tex', 'Competancy_mgt Documentation',
...
man_pages = [
    (master_doc, 'Competancy_mgt', 'Competancy_mgt Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Competancy_mgt', 'Competancy_mgt Documentation',
     author, 'Competancy_mgt', 'One line description of project.',
     'Miscellaneous'),
]
